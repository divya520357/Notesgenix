...
const Home = () => {
    ...
    const notes = [
        ...
        { name: "Physiology", id: 7, owner: 'luck01', type:'note' },
    ...
    return (
        <>
            ...
            <div className="home_nav my-2 d-flex justify-content-center align-items-center position-relative">
                ...
                <button ref={btnShared} onClick={filterShared} className='bg-transparent border-0 mx-3 w-50 fs-5 text-gray text-decoration-none text-center position-relative'>Favourites </button>
