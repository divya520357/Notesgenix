        ...
        <>
            <div className="footer-container position-fixed bottom-0 w-100">
                ...
                <div className="footer-bar d-flex align-items-center justify-content-center mt-1 mb-2">
                    ...
                    <Link className="footer-btn d-flex flex-column justify-content-center align-items-center text-decoration-none" to='/books'>
                        <i className="fa-solid fa-book p-1"></i>
                        Books
                    </Link>
                    <Link className="footer-btn d-flex flex-column justify-content-center align-items-center text-decoration-none" to='/account'>
